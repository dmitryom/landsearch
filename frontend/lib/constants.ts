...
export const VRI_LABELS: Record<string, string> = {
  ИЖС: 'Индивидуальное жилищное строительство',
  ЛПХ: 'Личное подсобное хозяйство',
  СНТ: 'Садоводство',
  ОГОРОД: 'Огородничество',
  ДНП: 'Дачное хозяйство',
  ОГП: 'Территории общего пользования',
  ГАРАЖ: 'Гаражное назначение',
  КОМ: 'Коммерческое использование',
  СКЛАД: 'Складское назначение',
  ПРОМ: 'Промышленное назначение',
  КОММУН: 'Коммунальная инфраструктура',
  СХ: 'Сельскохозяйственное назначение',
  СПОРТ: 'Спортивные объекты',
  РИТУАЛ: 'Ритуальные объекты',
  ОТДЫХ: 'Отдых и рекреация',
  ЖИЛОЙ: 'Жилая застройка',
  СОЦИАЛЬНЫЙ: 'Социальные объекты',
  ТРАНСПОРТ: 'Транспортная инфраструктура',
  СВЯЗЬ: 'Объекты связи',
  ОБОРОНА: 'Оборона и безопасность',
  ЛЕСНОЙ: 'Лесной фонд',
  ВОДНЫЙ: 'Водный фонд',
  СПЕЦИАЛЬНЫЙ: 'Специальное назначение',
  ЗАПАС: 'Земли запаса',
  ПУСТЫРЬ: 'Неиспользуемая территория',
  ДРУГОЕ: 'Другое назначение',
}
