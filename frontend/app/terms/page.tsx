    ...
    <main className="min-h-screen bg-[var(--ls-paper)] px-4 py-10 text-[var(--ls-ink)] sm:px-6">
      <article className="mx-auto max-w-3xl rounded-lg border border-[var(--ls-line)] bg-[var(--ls-surface)] p-6 shadow-sm sm:p-10">
        ...
        <div className="mt-8 space-y-6 text-sm leading-6">
          ...
          <section><h2 className="text-lg font-semibold">2. Данные карты</h2><p className="mt-2">Кадастровые границы и атрибуты поступают из NSPD. Они предназначены для предварительного анализа и не заменяют выписку из ЕГРН, межевание, юридическую проверку или консультацию кадастрового инженера.</p></section>
